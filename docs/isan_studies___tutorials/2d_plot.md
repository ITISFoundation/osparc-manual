...
To begin, open the o<sup>2</sup>S<sup>2</sup>PARC platform in your browser and choose the 2D plot template in the bottom ribbon menu. Choose a descriptive name for your study – we will call it “PlotAdventure” - and then click “Create.”

You should now see your flowchart with a File Picker service and a 2D Plot service.
 
## Loading the Data

Double-click on File Picker which will bring you to the file selection menu. Expanding “My Data” you should be able to see the folder “simcor.” Selecting this, click on “Add file(s)” to add the provided “RNAdat.csv” file.
...
Scrolling to the bottom, you will see options for plotting with Rawgraph and various data inputs for plots. Select oSPARC inputs and then selecting “input_1:RNAdat.csv” should load the data into the GUI. You are now ready to make your own 2D plot!
