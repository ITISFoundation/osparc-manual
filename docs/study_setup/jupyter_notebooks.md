...
**NOTE: We no longer encourage the use of Jupyter Notebooks and instead recommend the use of our [JupyterLab Services](/docs/study_setup/JupyterLabs.md) instead for your interactive scripting needs. They are more versatile than Jupyter Notebooks and have useful features such as Git integration and support for multiple file types**
